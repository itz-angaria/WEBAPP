  ...
  return (
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarNavDropdown">
        <ul class="navbar-nav">
          <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="/">ADD SALES</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="/topsale">TOP 5 SALES</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="/revenue">TODAY'S TOTAL REVENUE</a>
          </li>
